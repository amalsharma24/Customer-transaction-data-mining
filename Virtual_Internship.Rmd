...
library(tidyverse)
library("readxl")
customer_transaction <- read_excel('/cloud/project/KPMG_final.xlsx')
customer_transaction
new_cust <- read_excel('/cloud/project/KPMG_final.xlsx', sheet = 2)
new_cust
cust_demo <- read_excel('/cloud/project/KPMG_final.xlsx', sheet = 3)
cust_demo
cust_address<- read_excel('/cloud/project/KPMG_final.xlsx', sheet = 4)
cust_address
```
...
write.csv(new_cust,"new_cust.csv", row.names = FALSE)
```
